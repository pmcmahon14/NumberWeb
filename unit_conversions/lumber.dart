const List<String> lumberArray = ['Board Feet (FBM)', 'Cord (cd)', 'Cord (80 Cubic Feet) (cd)',
...
String lumberInitValue1 = 'Cubic Meter (m³)';
String lumberInitValue2 = 'Board Feet (FBM)';

//based on 1 cubic meter
const List<double> lumberConvArray = [423.7760007, 0.2758958338, 0.441433334, 2.20716667, 10.59440002, 35.31466672,

const List<String> speedArray = ['Centimeter/Day (cm/d)', 'Centimeter/Hour (cm/hr)', 'Centimeter/Minute (cm/min)',
...
String speedInitValue1 = 'Meter/Second (m/s)';
String speedInitValue2 = 'Mile/Hour (mi/hr)';

//based on 1 meter/second
const List<double> speedConvArray = [8640000, 360000, 6000, 100, 283464.57, 11811.02, 196.85, 3.28, 429.49, 17.9,

const List<String> visDynArray = ['Dyne Second/Square Centimeter (dyn·s/cm)²', 'Gram/Centimeter/Second (g/cm/s)',
...
String visDynInitValue1 = 'Pascal Second (Pa·s)';
String visDynInitValue2 = 'Poise (P)';

//based on 1 pascal/second
const List<double> visDynConvArray = [10, 10, 0.1019716213, 1000, 1, 1, 0.0001450377, 0.0208854342, 2419.09,

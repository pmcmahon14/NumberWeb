const List<String> volumeFlowArray = ['Cubic Meter/Day (m³/d)', 'Cubic Meter/Hour (m³/hr)',
...
String volumeFlowInitValue1 = 'Cubic Meter/Second (m³/s)';
String volumeFlowInitValue2 = 'Gallon (US)/Minute (gal/min)';

//based on 1 cubic meter/second
const List<double> volumeFlowConvArray = [86400, 3600, 60, 1, 8.64e10, 3.6e9, 60000000, 1000000, 86400000, 3600000,

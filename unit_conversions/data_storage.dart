const List<String> dataStorageArray = ['Bit', 'Byte', 'CD (74 min)', 'CD (80 min)', 'DVD (1 layer, 1 side)', 'DVD (1 layer, 2 sides)',
...
String dataStorageInitValue1 = 'Megabyte (MB)';
String dataStorageInitValue2 = 'Gigabyte (GB)';

//based on 1 byte
const List<double> dataStorageConvArray = [8000000, 1000000, 1.468303072e-9, 1.358180342e-9, 1.981537392e-10,

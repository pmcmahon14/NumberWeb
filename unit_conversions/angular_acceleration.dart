const List<String> angAccArray = ['Degree/Square Second(°/s²)', 'Degree/Square Millisecond(°/ms²)',
...
String angAccInitValue1 = 'Degree/Square Second(°/s²)';
String angAccInitValue2 = 'Radian/Square Second(rad/s²)';

//based on 1 degree/square second
const List<double> angAccConvArray = [1, 0.000001, 3600, 12960000, 7.46496e9, 1.11, 1.1111111111e-6, 4000,

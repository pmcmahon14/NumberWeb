const List<String> angVelArray = ['Degree/Second(°/s)', 'Degree/Millisecond(°/ms)', 'Degree/Minute(°/min)',
...
String angVelInitValue1 = 'Degree/Second(°/s)';
String angVelInitValue2 = 'Radian/Second(rad/s)';

//based on 1 degree/second
const List<double> angVelConvArray = [1, 0.001, 60, 3600, 86400, 1.1111111111, 0.0011111111111,
